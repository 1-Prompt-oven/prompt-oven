	...
	return (
		<div
			...
			<div
				...
				style={{ color: "#e0e0e0" }}>
				{/* 배경 별 색상 설정 */}
				<button type="button" onClick={() => changeStarHandler(1)}>
					★
				</button>
				<button type="button" onClick={() => changeStarHandler(2)}>
					★
				</button>
				<button type="button" onClick={() => changeStarHandler(3)}>
					★
				</button>
				<button type="button" onClick={() => changeStarHandler(4)}>
					★
				</button>
				<button type="button" onClick={() => changeStarHandler(5)}>
					★
				</button>
			</div>
			<div
