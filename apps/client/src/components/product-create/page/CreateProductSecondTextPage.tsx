...
// import { getProductDetail } from "@/action/product/productUpsertAction.ts"
...
// 				if (productUuid) {
// 					setValue(
// 						createProductSecondTextSchemaKeys.promptResult,
// 						productData.productName, // This is incorrect. It should be promptVars
// 					)
